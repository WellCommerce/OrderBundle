(function (Translator) {
    ...
    Translator.add("This field was not expected.", "Ruas ini tidak diharapkan.", "validators", "id");
    Translator.add("This field is missing.", "Ruas ini hilang.", "validators", "id");
    ...
    Translator.add("This value is not a valid email address.", "Nilai ini bukan alamat surel yang sah.", "validators", "id");
    Translator.add("The file could not be found.", "Berkas tidak dapat ditemukan.", "validators", "id");
    Translator.add("The file is not readable.", "Berkas tidak dapat dibaca.", "validators", "id");
    ...
    Translator.add("The mime type of the file is invalid ({{ type }}). Allowed mime types are {{ types }}.", "Jenis berkas ({{ type }}) tidak sah. Jenis berkas yang diizinkan adalah {{ types }}.", "validators", "id");
    ...
    Translator.add("The file is too large. Allowed maximum size is {{ limit }} {{ suffix }}.", "Ukuran berkas terlalu besar. Ukuran maksimum yang diizinkan adalah {{ limit }} {{ suffix }}.", "validators", "id");
    ...
    Translator.add("This file is not a valid image.", "Berkas ini tidak termasuk citra.", "validators", "id");
    ...
    Translator.add("The size of the image could not be detected.", "Ukuran dari citra tidak bisa dideteksi.", "validators", "id");
    Translator.add("The image width is too big ({{ width }}px). Allowed maximum width is {{ max_width }}px.", "Lebar citra terlalu besar ({{ width }}px). Ukuran lebar maksimum adalah {{ max_width }}px.", "validators", "id");
    Translator.add("The image width is too small ({{ width }}px). Minimum width expected is {{ min_width }}px.", "Lebar citra terlalu kecil ({{ width }}px). Ukuran lebar minimum yang diharapkan adalah {{ min_width }}px.", "validators", "id");
    Translator.add("The image height is too big ({{ height }}px). Allowed maximum height is {{ max_height }}px.", "Tinggi citra terlalu besar ({{ height }}px). Ukuran tinggi maksimum adalah {{ max_height }}px.", "validators", "id");
    Translator.add("The image height is too small ({{ height }}px). Minimum height expected is {{ min_height }}px.", "Tinggi citra terlalu kecil ({{ height }}px). Ukuran tinggi minimum yang diharapkan adalah {{ min_height }}px.", "validators", "id");
    ...
    Translator.add("The image ratio is too big ({{ ratio }}). Allowed maximum ratio is {{ max_ratio }}.", "Rasio citra terlalu besar ({{ ratio }}). Rasio maksimum yang diizinkan adalah {{ max_ratio }}.", "validators", "id");
    Translator.add("The image ratio is too small ({{ ratio }}). Minimum ratio expected is {{ min_ratio }}.", "Rasio citra terlalu kecil ({{ ratio }}). Rasio minimum yang diharapkan adalah {{ min_ratio }}.", "validators", "id");
    Translator.add("The image is square ({{ width }}x{{ height }}px). Square images are not allowed.", "Citra persegi ({{ width }}x{{ height }}px). Citra persegi tidak diizinkan.", "validators", "id");
    Translator.add("The image is landscape oriented ({{ width }}x{{ height }}px). Landscape oriented images are not allowed.", "Citra berorientasi lanskap ({{ width }}x{{ height }}px). Citra berorientasi lanskap tidak diizinkan.", "validators", "id");
    Translator.add("The image is portrait oriented ({{ width }}x{{ height }}px). Portrait oriented images are not allowed.", "Citra berorientasi potret ({{ width }}x{{ height }}px). Citra berorientasi potret tidak diizinkan.", "validators", "id");
    Translator.add("An empty file is not allowed.", "Berkas kosong tidak diizinkan.", "validators", "id");
    Translator.add("The host could not be resolved.", "Host tidak dapat diselesaikan.", "validators", "id");
    Translator.add("This value does not match the expected {{ charset }} charset.", "Nilai ini tidak memenuhi set karakter {{ charset }} yang diharapkan.", "validators", "id");
    Translator.add("This is not a valid Business Identifier Code (BIC).", "Ini bukan Business Identifier Code (BIC) yang sah.", "validators", "id");
