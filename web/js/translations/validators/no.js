(function (Translator) {
    ...
    Translator.add("This value should be of type {{ type }}.", "Verdien skal ha typen {{ type }}.", "validators", "no");
    Translator.add("This value should be blank.", "Verdien skal v\u00e6re blank.", "validators", "no");
    ...
    Translator.add("This value should not be blank.", "Verdien kan ikke v\u00e6re blank.", "validators", "no");
    Translator.add("This value should not be null.", "Verdien kan ikke v\u00e6re tom (null).", "validators", "no");
    Translator.add("This value should be null.", "Verdien skal v\u00e6re tom (null).", "validators", "no");
    Translator.add("This value is not valid.", "Verdien er ugyldig.", "validators", "no");
    ...
    Translator.add("The two values should be equal.", "Verdiene skal v\u00e6re identiske.", "validators", "no");
    ...
    Translator.add("This value should be a valid number.", "Verdien skal v\u00e6re et gyldig tall.", "validators", "no");
    ...
    Translator.add("This value should be the user's current password.", "Verdien skal v\u00e6re brukerens sitt n\u00e5v\u00e6rende passord.", "validators", "no");
    Translator.add("This value should have exactly {{ limit }} character.|This value should have exactly {{ limit }} characters.", "Verdien skal v\u00e6re n\u00f8yaktig {{ limit }} tegn.", "validators", "no");
    ...
    Translator.add("Unsupported card type or invalid card number.", "Korttypen er ikke st\u00f8ttet eller kortnummeret er ugyldig.", "validators", "no");
    Translator.add("This is not a valid International Bank Account Number (IBAN).", "Dette er ikke et gyldig IBAN-nummer.", "validators", "no");
    ...
    Translator.add("This value should be equal to {{ compared_value }}.", "Verdien skal v\u00e6re lik {{ compared_value }}.", "validators", "no");
    Translator.add("This value should be greater than {{ compared_value }}.", "Verdien skal v\u00e6re st\u00f8rre enn {{ compared_value }}.", "validators", "no");
    Translator.add("This value should be greater than or equal to {{ compared_value }}.", "Verdien skal v\u00e6re st\u00f8rre enn eller lik {{ compared_value }}.", "validators", "no");
    Translator.add("This value should be identical to {{ compared_value_type }} {{ compared_value }}.", "Verdien skal v\u00e6re identisk med {{ compared_value_type }} {{ compared_value }}.", "validators", "no");
    Translator.add("This value should be less than {{ compared_value }}.", "Verdien skal v\u00e6re mindre enn {{ compared_value }}.", "validators", "no");
    Translator.add("This value should be less than or equal to {{ compared_value }}.", "Verdien skal v\u00e6re mindre enn eller lik {{ compared_value }}.", "validators", "no");
    Translator.add("This value should not be equal to {{ compared_value }}.", "Verdien skal ikke v\u00e6re lik {{ compared_value }}.", "validators", "no");
    Translator.add("This value should not be identical to {{ compared_value_type }} {{ compared_value }}.", "Verdien skal ikke v\u00e6re identisk med {{ compared_value_type }} {{ compared_value }}.", "validators", "no");
    Translator.add("The image ratio is too big ({{ ratio }}). Allowed maximum ratio is {{ max_ratio }}.", "Bildeforholdet er for stort ({{ ratio }}). Tillatt bildeforhold er maks {{ max_ratio }}.", "validators", "no");
    Translator.add("The image ratio is too small ({{ ratio }}). Minimum ratio expected is {{ min_ratio }}.", "Bildeforholdet er for lite ({{ ratio }}). Forventet bildeforhold er minst {{ min_ratio }}.", "validators", "no");
