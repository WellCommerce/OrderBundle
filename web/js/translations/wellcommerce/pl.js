(function (Translator) {
    ...
    Translator.add("product.form.fieldset.variants", "Warianty", "wellcommerce", "pl");
    ...
    Translator.add("product.button.show_in_shop", "Poka\u017c w sklepie", "wellcommerce", "pl");
    ...
    Translator.add("product.options.order_by.name.asc", "Od A do Z", "wellcommerce", "pl");
    Translator.add("product.options.order_by.name.desc", "Od Z do A", "wellcommerce", "pl");
    Translator.add("product.options.order_by.final_price.asc", "Cena - \u2191", "wellcommerce", "pl");
    Translator.add("product.options.order_by.final_price.desc", "Cena - \u2193", "wellcommerce", "pl");
    Translator.add("product.options.order_by.hierarchy.asc", "Domy\u015blnie", "wellcommerce", "pl");
    ...
    Translator.add("sales_report.label.current_period", "w tym okresie", "wellcommerce", "pl");
    ...
    Translator.add("order.heading.confirm", "Potwierdzenie zam\u00f3wienia", "wellcommerce", "pl");
    ...
    Translator.add("order.heading.cart", "Koszyk", "wellcommerce", "pl");
    Translator.add("order.heading.comments", "Twoje uwagi", "wellcommerce", "pl");
    Translator.add("order.heading.methods", "P\u0142atno\u015b\u0107 i wysy\u0142ka", "wellcommerce", "pl");
    ...
    Translator.add("order.label.product_total.net_price", "Warto\u015b\u0107 netto produkt\u00f3w", "wellcommerce", "pl");
    Translator.add("order.label.product_total.tax_amount", "Warto\u015b\u0107 podatku produkt\u00f3w", "wellcommerce", "pl");
    Translator.add("order.label.product_total.gross_price", "Warto\u015b\u0107 brutto produkt\u00f3w", "wellcommerce", "pl");
    Translator.add("order.label.summary.net_amount", "Warto\u015b\u0107 netto", "wellcommerce", "pl");
    Translator.add("order.label.summary.tax_amount", "Warto\u015b\u0107 podatku", "wellcommerce", "pl");
    Translator.add("order.label.summary.gross_amount", "Warto\u015b\u0107 brutto \u0142\u0105czna", "wellcommerce", "pl");
    Translator.add("order.label.shipping_total", "Koszty przesy\u0142ki", "wellcommerce", "pl");
    Translator.add("order.label.shipping_cost", "Koszty przesy\u0142ki", "wellcommerce", "pl");
    ...
    Translator.add("order.label.products", "Produkty", "wellcommerce", "pl");
    ...
    Translator.add("order.label.coupon.code", "Kod kuponu", "wellcommerce", "pl");
    ...
    Translator.add("order.address.label.line1", "Ulica", "wellcommerce", "pl");
    Translator.add("order.address.label.line2", "Nr. budynku, nr. lokalu", "wellcommerce", "pl");
    Translator.add("order.address.label.province", "Prowincja", "wellcommerce", "pl");
    Translator.add("order.address.label.postal_code", "Kod pocztowy", "wellcommerce", "pl");
    ...
    Translator.add("payment.heading.initialize", "P\u0142atno\u015b\u0107", "wellcommerce", "pl");
    ...
    Translator.add("payment_method.label.bank_transfer.tip", "Twoje zam\u00f3wienie b\u0119dzie realizowane po otrzymaniu przelewu na poni\u017csze dane rachunku.", "wellcommerce", "pl");
    Translator.add("payment_method.label.bank_transfer.account", "Numer rachunku", "wellcommerce", "pl");
    Translator.add("payment_method.label.bank_transfer.sort_number", "Sort code banku", "wellcommerce", "pl");
    Translator.add("payment_method.label.bank_transfer.title", "Tytu\u0142 przelewu", "wellcommerce", "pl");
    ...
    Translator.add("shop.label.mailer_configuration.bcc", "BCC", "wellcommerce", "pl");
    ...
    Translator.add("client.label.conditions_accepted", "Akceptuj\u0119 regulamin sklepu", "wellcommerce", "pl");
    ...
    Translator.add("client.label.terms_and_conditions", "Zasady oraz warunki", "wellcommerce", "pl");
    Translator.add("client.label.last_active", "Aktywny", "wellcommerce", "pl");
    Translator.add("client.label.cart", "Koszyk", "wellcommerce", "pl");
    Translator.add("client.label.create_account", "Za\u0142\u00f3\u017c konto", "wellcommerce", "pl");
    ...
    Translator.add("client.label.address.line1", "Ulica", "wellcommerce", "pl");
    Translator.add("client.label.address.line2", "Nr. budynku, nr. lokalu", "wellcommerce", "pl");
    ...
    Translator.add("client.heading.client", "Klient", "wellcommerce", "pl");
    ...
    Translator.add("client.heading.orders", "Zam\u00f3wienia", "wellcommerce", "pl");
    Translator.add("client.heading.address_book", "Adresy", "wellcommerce", "pl");
    Translator.add("client.heading.settings", "Ustawienia", "wellcommerce", "pl");
    Translator.add("client.heading.wishlist", "Lista \u017cycze\u0144", "wellcommerce", "pl");
    ...
    Translator.add("client.link.wishlist", "Schowek", "wellcommerce", "pl");
    ...
    Translator.add("client.button.save_changes", "Zapisz zmiany", "wellcommerce", "pl");
    Translator.add("client.flash.registration.error", "Formularz zawiera niepoprawne dane.", "wellcommerce", "pl");
    Translator.add("client.flash.registration.success", "Twoje konto zosta\u0142o za\u0142o\u017cone. Mo\u017cesz si\u0119 teraz zalogowa\u0107.", "wellcommerce", "pl");
    ...
    Translator.add("contact_ticket.index.contact", "Kontakt", "wellcommerce", "pl");
    Translator.add("contact_ticket.flash.success", "Wiadomo\u015b\u0107 zosta\u0142a wys\u0142ana.", "wellcommerce", "pl");
    Translator.add("contact_ticket.flash.error", "Wiadomo\u015b\u0107 nie zosta\u0142a wys\u0142ana. Formularz zawiera b\u0142\u0119dy.", "wellcommerce", "pl");
    Translator.add("contact_ticket.error.email.not_valid", "Podany adres e-mail jest nieprawid\u0142owy", "wellcommerce", "pl");
    Translator.add("contact_ticket.error.email.not_blank", "Pole \"Adres e-mail\" nie mo\u017ce by\u0107 puste", "wellcommerce", "pl");
    Translator.add("contact_ticket.error.subject.not_blank", "Pole \"Temat wiadomo\u015bci\" nie mo\u017ce by\u0107 puste", "wellcommerce", "pl");
    Translator.add("contact_ticket.error.content.not_blank", "Pole \"Tre\u015b\u0107 wiadomo\u015bci\" nie mo\u017ce by\u0107 puste", "wellcommerce", "pl");
    Translator.add("contact_ticket.error.name.not_blank", "Pole \"Imi\u0119\" nie mo\u017ce by\u0107 puste", "wellcommerce", "pl");
    Translator.add("contact_ticket.error.surname.not_blank", "Pole \"Nazwisko\" nie mo\u017ce by\u0107 puste", "wellcommerce", "pl");
    Translator.add("contact_ticket.label.email", "Adres e-mail", "wellcommerce", "pl");
    Translator.add("contact_ticket.label.subject", "Temat wiadomo\u015bci", "wellcommerce", "pl");
    Translator.add("contact_ticket.label.content", "Tre\u015b\u0107 wiadomo\u015bci", "wellcommerce", "pl");
    Translator.add("contact_ticket.label.name", "Imi\u0119", "wellcommerce", "pl");
    Translator.add("contact_ticket.label.surname", "Nazwisko", "wellcommerce", "pl");
    Translator.add("contact_ticket.label.phone_number", "Telefon", "wellcommerce", "pl");
    Translator.add("shipment.heading.index", "Przesy\u0142ki", "wellcommerce", "pl");
    Translator.add("shipment.heading.add", "Dodaj przesy\u0142k\u0119", "wellcommerce", "pl");
    Translator.add("shipment.heading.edit", "Edytuj przesy\u0142k\u0119", "wellcommerce", "pl");
    Translator.add("shipment.label.guid", "GUID", "wellcommerce", "pl");
    Translator.add("shipment.label.package_number", "Numer przesy\u0142ki", "wellcommerce", "pl");
    Translator.add("shipment.label.courier", "Kurier", "wellcommerce", "pl");
    Translator.add("shipment.label.order_number", "Numer zam\u00f3wienia", "wellcommerce", "pl");
    Translator.add("shipment.fieldset.costs", "Ustawienia koszt\u00f3w wysy\u0142ki", "wellcommerce", "pl");
    Translator.add("shipment.fieldset.countries", "Pa\u0144stwa", "wellcommerce", "pl");
    ...
    Translator.add("coupon.error.minimum_order_value", "Warto\u015b\u0107 produkt\u00f3w w koszyku jest niewystarczaj\u0105ca do wykorzystania kuponu", "wellcommerce", "pl");
    Translator.add("coupon.error.only_promotion_products", "Tego kuponu nie mo\u017cesz wykorzysta\u0107 z produktami b\u0119d\u0105cymi w promocji", "wellcommerce", "pl");
    ...
    Translator.add("review.label.content", "Zostaw tutaj sw\u00f3j komentarz", "wellcommerce", "pl");
    Translator.add("review.label.recommendation_exists", "Recenzja zosta\u0142a ju\u017c oceniona.", "wellcommerce", "pl");
    Translator.add("review.label.review_not_exists", "Recenzja nie istnieje.", "wellcommerce", "pl");
    ...
    Translator.add("review.flash.error", "Opinia nie zosta\u0142a dodana. Formularz zawiera b\u0142\u0119dy.", "wellcommerce", "pl");
    Translator.add("report.flash.success", "Raport opinii zosta\u0142 wys\u0142any.", "wellcommerce", "pl");
    Translator.add("report.flash.error", "Raport opinii nie zosta\u0142 wys\u0142any.", "wellcommerce", "pl");
    ...
    Translator.add("shipping_method.label.options_provider", "Service opcji wysy\u0142ki", "wellcommerce", "pl");
    Translator.add("shipping_method.fieldset.costs", "Ustawienia koszt\u00f3w wysy\u0142ki", "wellcommerce", "pl");
    Translator.add("shipping_method.fieldset.countries", "Pa\u0144stwa", "wellcommerce", "pl");
    ...
    Translator.add("layout_box.showcase.tip", "Wybierz status dla kt\u00f3rego b\u0119d\u0105 wy\u015bwietlane produkty w boksie", "wellcommerce", "pl");
    ...
    Translator.add("common.label.featured", "Polecany", "wellcommerce", "pl");
    ...
    Translator.add("common.label.tax_rate", "Stawka VAT", "wellcommerce", "pl");
    ...
    Translator.add("common.label.line1", "Pierwsza linia adresu", "wellcommerce", "pl");
    ...
    Translator.add("common.label.yes", "Tak", "wellcommerce", "pl");
    Translator.add("common.label.no", "Nie", "wellcommerce", "pl");
