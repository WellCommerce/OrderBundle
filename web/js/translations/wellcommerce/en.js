(function (Translator) {
    ...
    Translator.add("client.label.address.line1", "Address line 1", "wellcommerce", "en");
    ...
    Translator.add("client.flash.registration.success", "Registration complete. Please sign-in now.", "wellcommerce", "en");
    ...
    Translator.add("common.label.featured", "Featured", "wellcommerce", "en");
    ...
    Translator.add("common.label.line1", "Address line 1", "wellcommerce", "en");
    ...
    Translator.add("address.label.line1", "Address line 1", "wellcommerce", "en");
    Translator.add("address.label.line2", "Address line 2", "wellcommerce", "en");
    Translator.add("address.label.province", "Province", "wellcommerce", "en");
    Translator.add("address.label.postal_code", "Post code", "wellcommerce", "en");
    ...
    Translator.add("product.button.show_in_shop", "Show in shop", "wellcommerce", "en");
    ...
    Translator.add("coupon.error.minimum_order_value", "The value of the products in the basket is not sufficient to use the coupon", "wellcommerce", "en");
    Translator.add("coupon.error.only_promotion_products", "Coupon cannot be used with promotions", "wellcommerce", "en");
    ...
    Translator.add("review.label.recommendation_exists", "Review has already been assessed.", "wellcommerce", "en");
    Translator.add("review.label.review_not_exists", "Review not exists.", "wellcommerce", "en");
    ...
    Translator.add("layout_box.showcase.tip", "Choose a status to display the products in the showcase box", "wellcommerce", "en");
