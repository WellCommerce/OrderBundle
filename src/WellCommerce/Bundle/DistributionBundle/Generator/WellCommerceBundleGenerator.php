...
use WellCommerce\Bundle\DistributionBundle\Generator\Model\WellCommerceBundle;
...
final class WellCommerceBundleGenerator
{
    ...
    private function generateBundleClass(string $vendor, string $prefix): string
    {
        ...
        $content = $this->twig->render('WellCommerceDistributionBundle:skeleton/bundle:Bundle.php.twig', [
            'prefix' => $prefix,
            'vendor' => $vendor,
        ]);
    ...
    private function generateClasses(WellCommerceBundle $bundle)
    {
        ...
        foreach ($classTemplates as $template => $target) {
            $content = $this->twig->render('WellCommerceDistributionBundle:skeleton/bundle:' . $template, [
                'bundle' => $bundle,
            ]);
    ...
    {
        $content        = $this->twig->render('WellCommerceDistributionBundle:skeleton/bundle:config/config.yml.twig');
    ...
    {
        $content = $this->twig->render('WellCommerceDistributionBundle:skeleton/bundle:config/routing.yml.twig', [
            'bundle' => $bundle,
        ]);
    ...
    private function generateDoctrineConfiguration(WellCommerceBundle $bundle)
    {
        ...
        $ormTemplate        = 'WellCommerceDistributionBundle:skeleton/bundle:Doctrine/Entity.orm.yml.twig';
        ...
        $ormTranslationTemplate        = 'WellCommerceDistributionBundle:skeleton/bundle:Doctrine/EntityTranslation.orm.yml.twig';
    ...
    private function generateTemplates(WellCommerceBundle $bundle)
    {
        ...
        foreach ($files as $file) {
            $content = $this->twig->render('WellCommerceDistributionBundle:skeleton/bundle:views/' . $file, [
                'bundle' => $bundle,
            ]);
