...
GF_Datagrid = GF_Instance.GF_Extend('GF_Datagrid', function(jTarget, oOptions) {
	...
	*/
	...
	this._InitializeEvents = function() {
		...
		$(document).on('click', '.GF_Datagrid_Modify_columns .save a', this._HandleSaveColumns);
	...
	ProcessIncomingData: GF.NewEventHandler(function(oData) {
		if ((oData.data_id == undefined) || !(GF_Instance.s_aoInstances[oData.data_id] instanceof GF_Datagrid)) {
			GF_Debug.Error('The server has responded with an invalid data.<br />' + oData.error);
		}
...
GF_Datagrid.Files = {
	modify_columns_icon: GCore.DESIGN_PATH + 'images/datagrid/modify-columns.png',
	retract_filters_icon: GCore.DESIGN_PATH + 'images/datagrid/filter-retract.png',
	expand_filters_icon: GCore.DESIGN_PATH + 'images/datagrid/filter-expand.png',
	order_asc: GCore.DESIGN_PATH + 'images/datagrid/sort-asc.png',
	order_desc: GCore.DESIGN_PATH + 'images/datagrid/sort-desc.png',
	delete_group_icon: GCore.DESIGN_PATH + 'images/icons/datagrid/delete.png',
	delete_row_icon: GCore.DESIGN_PATH + 'images/icons/datagrid/delete.png',
	edit_row_icon: GCore.DESIGN_PATH + 'images/icons/datagrid/edit.png',
	view_row_icon: GCore.DESIGN_PATH + 'images/icons/datagrid/details.png',
	first_page_icon: GCore.DESIGN_PATH + 'images/datagrid/page-first.png',
	prev_page_icon: GCore.DESIGN_PATH + 'images/datagrid/page-prev.png',
	next_page_icon: GCore.DESIGN_PATH + 'images/datagrid/page-next.png',
	last_page_icon: GCore.DESIGN_PATH + 'images/datagrid/page-last.png',
	clear_selection_icon: GCore.DESIGN_PATH + 'images/datagrid/clear-selection.png',
	save_icon: GCore.DESIGN_PATH + 'images/icons/datagrid/save.png',
